...
| `extra-skill` | Refonte de design sur le thème **Extra** (builder Divi legacy `et_pb_*`, category builder, tokens et_extra) — extrait du code réel + site pilote, règle « imiter, pas inventer » | [README](extra-skill/README.md) |
